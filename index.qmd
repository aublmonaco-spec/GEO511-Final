...
9.  I followed the same steps to find data for Ruby-throated Hummingbird migration and found their average arrival dates for various latitudes between 2000 and 2017 (since more data for this early period was needed). I used data from eBird in addition to iNaturalist and the US National Phenology Network.
...
rth_early <- ruby_throat %>%
  filter(Year %in% c(2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015) & Month %in% c(3, 4, 5))
...
rth_new_all <- ruby_throat %>%
  filter(Year %in% c(2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025) & Month %in% c(3, 4, 5)) %>%
  mutate(mean0014 = case_when(Latitude > 30 & Latitude < 33 ~ 95.95455,
                              Latitude > 33 & Latitude < 36 ~ 108.6842,
                              Latitude > 36 & Latitude < 39 ~ 112.6667,
                              Latitude > 39 & Latitude < 42 ~ 125.8839,
                              Latitude > 42 & Latitude < 45 ~ 141.52
                              ))
...
-   30-33: April 9th (About 3 days later)

-   33-36: April 11th (About 2 days later)

-   36-39: April 21st (About 2 days earlier)

-   39-42: May 13th (About the same (or 1/3 of a day earlier))

-   42-45: May 16th (About 3 days earlier)
