---
title: "Phenological Mismatches in Pollination Pals"
author: Aubrey Monaco
subtitle: Phenological Shifts in the Ruby-Throated Hummingbird and its Preferred Flowers
date: today
date-format: long
editor_options:
...
ggplot() + geom_line(data = early_rth_plot, aes(x = Month, y = number), color = "darkblue") + geom_line(data = new_rth_plot, aes(x = Month, y = number), color = "darkred")  + labs(title = "Comparing Ruby-throat Observations", x = "Month", y = "Number of Observations") + theme(plot.title = element_text(family = "serif", size = 12), axis.title = element_text(family = "serif", size = 10), panel.background = element_blank(), panel.grid = element_line(color = "lightgray"))
