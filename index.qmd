...
access_key <- set_ebirdst_access_key("d11niqj0rd7u", overwrite = TRUE)

get_species("Ruby-throated Hummingbird")

test_rth <- ebirdst_download_trends("rthhum")
...
```{r, message=FALSE, warning=FALSE}
#cf2010 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2010)

#cf2011 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2011)

#cf2012 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2012, maxresults = 5000)

#cf2013 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2013, maxresults = 5000)

#cf2014 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2014, maxresults = 5000)

#cf2015 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2015, maxresults = 5000)

#cf2016 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2016, maxresults = 5000)

#cf2017 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2017, maxresults = 5000)

#cf2018 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2018, maxresults = 5000)

#cf2019 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2019, maxresults = 5000)

#cf2020 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2020, maxresults = 10000)

#cf2021 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2021, maxresults = 10000)

#cf2022 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2022, maxresults = 10000)

#cf2023 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2023, maxresults = 10000)

#cf2024 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2024, maxresults = 10000)

#cf2025 <- get_inat_obs(taxon_name = "Lobelia cardinalis", query = "flower", year = 2025, maxresults = 10000)
...
#cardinal_all <- cardinal_all %>%
  #rename(latitude = Latitude, longitude = Longitude)

write.csv(cf_all, "cf_all.csv")
