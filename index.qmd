...
fl_all <- rbind(fl_2000, fl_2001, fl_2002, fl_2003, fl_2004, fl_2005, fl_2006, fl_2007, fl_2008, fl_2009, fl_2010, fl_2011, fl_2012, fl_2013, fl_2014, fl_2015, fl_2016, fl_2017, fl_2018, fl_2019, fl_2020, fl_2021, fl_2022, fl_2023, fl_2024, fl_2025)
...
```{r, message=FALSE, warning=FALSE}
fl_early <- all_flower %>%
  filter(year %in% c(2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015) & month %in% c(2, 3, 4, 5, 6))
...
flower_new <- flower_early_all %>%
  filter(year %in% c(2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025) & month %in% c(2, 3, 4, 5, 6)) %>%
...
rth_1017 <- read.csv("data/RTH_1995_2021.csv")
rth_1825 <- read.csv("data/RTH_2022_2025.csv")

rth_ebird <- rth_1017 %>% full_join(rth_1825)
...
rth_early <- ruby_throat %>%
  filter(Year %in% c(2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014) & Month %in% c(2, 3, 4, 5))
...
rth_all <- ruby_throat_all %>%
  filter(Year %in% c(2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025) & Month %in% c(2, 3, 4, 5)) %>%
